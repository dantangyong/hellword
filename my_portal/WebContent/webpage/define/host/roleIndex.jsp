...
<head>
	...
	<script type="text/javascript">
		function refresh(){//刷新
			window.location="${ctx}/pluginjsp/host/plugins/authority";
		}
	</script>
</head>
<body class="gray-bg">
	...
	<div id="content" class="row">
		...
		<div id="right"  class="col-sm-11  animated fadeInRight">
			<iframe id="roleContent" name="roleContent" src="${ctx}/pluginjsp/host/plugins/roleList" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	</div>
	</div>
	<script type="text/javascript">
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			callback:{onClick:function(event, treeId, treeNode){
					...
					$('#roleContent').attr("src","${ctx}/pluginjsp/host/plugins/roleList?parent.id="+id+"&parentIds="+treeNode.pIds);
				}
			}
		};
