...
<div class="wrapper wrapper-content">
	...
	<form:form id="inputForm" modelAttribute="site" action="${ctx}/cms/site/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="name" htmlEscape="false" class="form-control input-sm" style="width:400px"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">站点标题:</label>
			<div class="controls">
				<form:input path="title" htmlEscape="false" maxlength="200" class="form-control input-sm" style="width:300px"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="keywords" htmlEscape="false" class="form-control input-sm" style="width:200px"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="theme" class="input-medium form-control" cssStyle="width:160px">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="customIndexView" htmlEscape="false" class="form-control input-sm" style="width:200px"/>
			</div>
		</div>
