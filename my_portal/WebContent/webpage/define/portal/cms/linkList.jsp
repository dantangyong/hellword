...
<div class="ibox-content">
	...
	<form:form id="searchForm" modelAttribute="link" action="${ctx}/cms/link/" method="post" class="breadcrumb form-search form-inline title-top">
		...
		<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
		  ...
		  <div class="form-group">
		    <label>状态：</label>
		    <form:radiobuttons class="i-checks" onclick="$('#searchForm').submit();" path="delFlag" items="${fns:getDictList('cms_del_flag')}" itemLabel="label" itemValue="value" htmlEscape="false" />
		  </div>
	</form:form>
