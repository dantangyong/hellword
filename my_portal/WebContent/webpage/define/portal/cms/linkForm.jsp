...
<div class="wrapper wrapper-content">
	...
	<form:form id="inputForm" modelAttribute="link" action="${ctx}/cms/link/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls input-group">
                <sys:treeselect id="category" name="category.id" value="${link.category.id}" labelName="category.name" labelValue="${link.category.name}"
					title="栏目" url="/cms/category/treeData" module="link" selectScopeModule="true" notAllowSelectRoot="false" notAllowSelectParent="true" cssClass="input-small"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="href" htmlEscape="false" cssStyle="width:400px" class="form-control input-xxlarge measure-input required"/>
			</div>
		</div>
		<div class="control-group">
		...
		<shiro:hasPermission name="cms:article:audit">
			<div class="control-group">
				...
				<div class="controls">
					<form:radiobuttons class="i-checks" path="delFlag" items="${fns:getDictList('cms_del_flag')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
