...
<head>
	...
	<%@include file="front/include/treeview.jsp" %>
	<style type="text/css">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${templateList}" var="tpl">{id:"${tpl.name}", pId:"${not empty tpl.parent?tpl.parent:0}", name:"${tpl.filename}", fullName:"${tpl.name}", isDirectory: ${tpl.directory}},</c:forEach>];
			// 初始化树结构
