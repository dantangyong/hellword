...
$(function () {
    $('#calendar').eCalendar();
    $("#dayPlan").on("click",".c-day,.c-day-previous-month,.c-day-next-month",function () {
        $(".c-event-grid").css("visibility","visible");
        $(".c-event-list").html("今天暂无日程安排");
    }).on("mouseover",".c-day,.c-day-previous-month,.c-day-next-month",function () {
        $(this).css("border-bottom","1px solid lightblue");
    }).on("mouseleave",".c-day,.c-day-previous-month,.c-day-next-month",function () {
