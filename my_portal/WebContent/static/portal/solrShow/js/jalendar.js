...
$(function () {    
    (function ($) {
        $.fn.jalendar = function (options) {
            ...
            monthNames['zh-cn'] = new Array('一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月');
            ...
            $this.find('.jalendar-pages').css({'width' :"420px" });
            ...
            function prevAddEvent() {
                ...
                $this.children('.jalendar-wood').animate({'width' : 450}, 200);
                $this.children('.wood-bottom').animate({'width' : 450}, 200);
                $close.hide();
            }
