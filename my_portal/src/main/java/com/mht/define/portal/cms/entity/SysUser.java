...
public class SysUser {
	...
	public String toString() {
		return "SysUser [id=" + id + ", companyId=" + companyId + ", officeId=" + officeId + ", loginName=" + loginName
				...
				+ ", delFlag=" + delFlag + ", qrcode=" + qrcode + ", sign=" + sign + ", account=" + account + ", idNo="
				+ idNo + ", gender=" + gender + ", nation=" + nation + ", roleType=" + roleType + ", origin=" + origin
				+ ", education=" + education + ", duty=" + duty + ", otherDuty=" + otherDuty + ", outside=" + outside
